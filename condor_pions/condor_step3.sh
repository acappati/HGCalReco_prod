...
set +e
mkdir -p /grid_mnt/data__data.polcms/cms/cappati/240429_pions_step3/
mv histo.root /grid_mnt/data__data.polcms/cms/cappati/240429_pions_step3/step3_dumper_$INDEX.root
